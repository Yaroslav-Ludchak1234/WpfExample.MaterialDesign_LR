...
namespace WpfExample.MaterialDesign {
    ...
    public partial class itprogerDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string login, string pass, string email) {
...
namespace WpfExample.MaterialDesign.itprogerDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([login] = @Original_l" +
                "ogin) AND ([pass] = @Original_pass) AND ([email] = @Original_email))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([login], [pass], [email]) VALUES (@login, @pass, @emai" +
                "l);\r\nSELECT Id, login, pass, email FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [login] = @login, [pass] = @pass, [email] = @email WHERE (([Id] = @Original_Id) AND ([login] = @Original_login) AND ([pass] = @Original_pass) AND ([email] = @Original_email));
SELECT Id, login, pass, email FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfExample.MaterialDesign.Properties.Settings.Default.itprogerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, login, pass, email FROM dbo.[Table]";
        ...
        public virtual int Fill(itprogerDataSet.TableDataTable dataTable) {
        ...
        public virtual itprogerDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            itprogerDataSet.TableDataTable dataTable = new itprogerDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(itprogerDataSet.TableDataTable dataTable) {
